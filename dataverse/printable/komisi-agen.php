...
<body>
	...
	<p>Status : <span style="font-weight: bold">Belum Lunas</span></p>
	<br>
	...
	<table class="table table-striped table-bordered table-hover order-column" id="">
							...
							<?php
								...
								{
									$item_selling_query = mysql_query("SELECT * FROM item_selling a, invoice_detail b WHERE a.item_selling_id = b.item_selling_id AND b.invoice_id = '".$_GET['invoice_id']."' AND a.invoice_status = 'Belum Cair' AND a.item_selling_active = '1' GROUP BY a.item_selling_id");
								}
								else
								{
									$item_selling_query = mysql_query("SELECT * FROM item_selling a, invoice_detail b, reseller c, user d WHERE a.item_selling_id = b.item_selling_id AND b.reseller_id = c.reseller_id AND c.user_id = d.user_id AND d.item_category_id = '".$_SESSION['item_category_id']."' AND b.invoice_id = '".$_GET['invoice_id']."' AND a.invoice_status = 'Belum Cair' AND a.item_selling_active = '1' GROUP BY a.item_selling_id");
								}
